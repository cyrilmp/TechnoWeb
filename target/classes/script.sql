...
insert into User(name ,firstname,role,username,password) values ('Mahon-Puget','Cyril','Administrateur',"cymahon-pu","admin");
insert into User(name ,firstname,role,username,password) values ('Talabard','Jérémy','Administrateur',"jetalabard","admin");
insert into User(name ,firstname,role,username,password) values ('Toto','titi','Utilisateur',"test","test");
insert into User(name ,firstname,role,username,password) values ('Tata','yoyo','Utilisateur',"test2","test");
